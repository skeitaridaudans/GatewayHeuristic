/*
 * GatewayPathfindingStateSpace.cpp
 *
 *  Created on: Dec 15, 2014
 *      Author: kaha
 */

#include "GatewayPathfindingStateSpace.h"
#include <math.h>

namespace GatewayPathfinding {

GatewayPathfindingStateSpace::GatewayPathfindingStateSpace(GatewayMap *gMap)
...
GatewayPathfindingStateSpace::~GatewayPathfindingStateSpace()
{
}

double GatewayPathfindingStateSpace::shortestDistanceToGate(Tile tile, Gateway gateway)
{
...
double GatewayPathfindingStateSpace::evaluatedDistance(int stateID, int goalStateID)
{
